---
{"dg-publish":true,"permalink":"/计量经济学/附录：独立、均值独立与不相关/","tags":["线性模型"],"created":"2025-09-12 19:08","updated":"2025-11-02 10:44"}
---
...
> 联系 [[计量经济学/线性CEF模型\|线性CEF模型]] 中的 $E[e\mid X]=0$ 和 [[Linear Projection Model\|Linear Projection Model]] 中的 $Cov(X_j,e_p)=0$ 可以发现前者是比后者更强的假设。
