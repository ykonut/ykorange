---
{"dg-publish":true,"permalink":"/计量经济学/间奏：独立、均值独立与不相关/"}
---
...
\end{align*}
$$
> 联系 [[Linear CEF Model\|Linear CEF Model]] 中的 $E[e\mid X]=0$ 和 [[Linear Projection Model\|Linear Projection Model]] 中的 $Cov(X_j,e_p)=0$ 可以发现前者是比后者更强的假设。
