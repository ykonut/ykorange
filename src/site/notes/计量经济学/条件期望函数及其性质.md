---
{"dg-publish":true,"permalink":"/计量经济学/条件期望函数及其性质/","tags":["线性模型"],"created":"2025-09-12 19:18","updated":"2025-11-02 10:57","dg-note-properties":{"date created":"2025-09-12 19:18","date modified":"2025-11-02 10:57","tags":["线性模型"],"abbr":["CEF: Conditional Expectation Function"]}}
---


## 条件期望函数

设 $Y$ 和 $X$ 是两个随机变量，对于任意一个实数 $x\in \operatorname{supp}(X)$ 都仅存在一个实数 $E[Y\mid X=x]$ 与之对应，因此可以构造随机变量 $X$ 的映射 $X\to E[Y\mid X]$，称 $E[Y\mid X]$ 为条件期望函数 (CEF)。
