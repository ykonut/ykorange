---
{"dg-publish":true,"permalink":"/01 微观经济学/信息经济学/价格歧视合约/","created":"2024-06-16T20:36:18.471+08:00","updated":"2024-06-16T23:09:12.677+08:00"}
---
...
解得
$$
B'(q(c))=c+\frac{F(c)}{f(c)}
$$
作为对比，最优解满足
$$
B'(q(c))=c
$$
取 $c=\underline{c}$，$F(\underline{c})=0$，此时 $q^{FB}=q^{SB}$，即「高端不扭曲」；取 $c\in(\underline{c},\bar{c}]$，$q^{FB}>q^{SB}$，因此信息不对称使得高成本类型的企业供给相对不足。