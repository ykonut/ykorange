---
{"dg-publish":true,"permalink":"/微观经济学/数理经济学/CRS函数/","title":"CRS","tags":["数理经济学"],"created":"2025-09-12 18:58","updated":"2025-11-08 12:29","dg-note-properties":{"date created":"2025-09-12 18:58","date modified":"2025-11-08 12:29","tags":["数理经济学"],"title":"CRS"}}
---
...
1. 假设生产函数为 CRS 函数，边际产出递减（$f_{ii},f_{jj}\leq0$）
2. 假设生产函数为拟凹函数。
