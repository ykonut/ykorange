---
{"dg-publish":true,"permalink":"/微观经济学/马歇尔需求函数/","tags":["需求理论"],"created":"2024-10-12T10:25:14.000+08:00","updated":"2024-10-12T10:25:14.000+08:00"}
---

马歇尔需求函数是[[微观经济学/效用最大化\|效用最大化]]问题的解，代回目标函数可以得到[[微观经济学/间接效用函数\|间接效用函数]]。
...
马歇尔需求函数是 $0$ 次齐次函数，根据[[微观经济学/数理经济学/齐次函数#欧拉定理\|齐次函数#欧拉定理]]可得
$$
\begin{align}
...
将[[微观经济学/效用最大化\|效用最大化]]得到的马歇尔需求函数代回约束条件
$$
