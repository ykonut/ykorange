---
{"dg-publish":true,"permalink":"/微观经济学/信息经济学/逆向选择/","tags":["博弈论"],"created":"2025-09-12 18:58","updated":"2026-04-21 09:53","dg-note-properties":{"date created":"2025-09-12 18:58","date modified":"2026-04-21 09:53","tags":["博弈论"]}}
---
...
观察 IR2 和 IC1：目标函数关于 $w^B$ 是递减的，而 IR2 的左侧关于 $w^B$ 是递增的，因此 IR2 取等号；目标函数关于 $w^G$ 是递减的，而 IC1 的左侧关于 $w^G$ 是递增的，且 $w^G$ 的变动不影响 IR2，因此 IC1 也是取等号的。另外，我们**暂时忽略单调性条件**，最后验证。
