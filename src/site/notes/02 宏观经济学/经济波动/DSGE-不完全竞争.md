---
{"dg-publish":true,"permalink":"/02 宏观经济学/经济波动/DSGE-不完全竞争/","created":"2023-06-18T16:33:14.454+08:00","updated":"2024-06-08T17:38:11.036+08:00"}
---
...
假设中间品厂商使用 [[01 微观经济学/数理经济学/Cobb-Douglas函数\|Cobb-Douglas函数]]生产，最终品厂商使用连续型 [[01 微观经济学/数理经济学/CES函数\|CES函数]] 生产
...
> 这里似乎走了一个弯路，虽然从利润最大化问题起手，但实际上求的是条件要素需求函数，不如直接考虑 [[01 微观经济学/数理经济学/CES函数\|CES函数]]成本最小化更为直接。
...
\end{split}
$$
根据 [[01 微观经济学/数理经济学/Cobb-Douglas函数\|Cobb-Douglas函数]] 的性质可得
$$
...
\end{split}
$$
其中（这是因为根据 [[01 微观经济学/数理经济学/CRS函数\|CRS函数]] 的性质 $MC=AC$）
$$
...
还可以直接通过垄断厂商的[[01 微观经济学/数理经济学/弹性#弹性定价法\|弹性#弹性定价法]]
$$
